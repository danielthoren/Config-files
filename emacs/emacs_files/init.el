...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (irony use-package-ensure-system-package nlinum use-package-hydra virtualenv company-jedi jedi use-package rg rtags ag company-ctags org-edit-latex flycheck-clang-analyzer helm-lsp dap-mode company-lsp auto-yasnippet java-snippets org-bullets ctags-update counsel-etags spinner lsp-java jdee neotree neon-mode ac-clang flycheck-bashate dumb-jump ace-jump-zap aggressive-indent flycheck diff-hl magit company solaire-mode projectile ivy doom-themes dash cmake-ide cmake-font-lock)))
